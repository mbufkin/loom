...
**Overall:** PASS
**Gold docs:** 22 · PASS 22 · FAIL 0 · missing obs 0

Path = thin `kind → Path` table after Pass 1 (not a second model sort).

| Status | source_file | expected | got |
|--------|-------------|----------|-----|
| PASS | `023-breeds-of-livestock-cattle__action-plan.html` | `student_practice→E` | `student_practice→E` |
...
| PASS | `027-external-anatomy-of-livestock-terms-terminology__action-plan.html` | `student_practice→E` | `student_practice→E` |
