...
**Spine:** 7 — Class 1 — Dairy Breeds, Class 2 — Asian & African Breeds, Class 3 — British Breeds, Class 4 — Continental Breeds, Class 5 — American Breeds, Class 6 — Build a Breed Project, Class 7 — Review & Assessment
...
- `lesson:breeds-of-livestock-cattle:l7` — Class 7 — Review & Assessment

## Unit `external-anatomy-of-livestock-terms-terminology`

**Title:** External Anatomy of Livestock: Terms & Terminology
**Spine:** 6 — Class 1 — Anatomical Terms of Location, Class 2 — External Components of Livestock, Class 3 — Labeling External Anatomy Diagrams, Class 4 — Labeling Activities & Instructor Project, Class 5 — Continue Labeling Activities & Presentations, Class 6 — Assessment
...
- `lesson:external-anatomy-of-livestock-terms-terminology:l3` — Class 3 — Labeling External Anatomy Diagrams
- `lesson:external-anatomy-of-livestock-terms-terminology:l4` — Class 4 — Labeling Activities & Instructor Project
- `lesson:external-anatomy-of-livestock-terms-terminology:l5` — Class 5 — Continue Labeling Activities & Presentations
- `lesson:external-anatomy-of-livestock-terms-terminology:l6` — Class 6 — Assessment
