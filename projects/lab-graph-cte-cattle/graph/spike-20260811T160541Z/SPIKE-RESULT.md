# CTE graph sort spike — RESULT

**Overall:** PASS
**Unit:** `breeds-of-livestock-cattle`
**Lessons in spine:** 7 — Class 1 — Dairy Breeds, Class 2 — Asian & African Breeds, Class 3 — British Breeds, Class 4 — Continental Breeds, Class 5 — American Breeds, Class 6 — Build a Breed Project, Class 7 — Final Assessment

## Contract checks

| Check | Result |
|-------|--------|
| `lesson_nodes_ge_1` | PASS |
| `view_lesson_plan_is_lesson_plan` | PASS |
| `view_lesson_plan_path_A` | PASS |
...
## Kind → Path preview (thin table, not a model)
