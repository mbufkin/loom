...
**Spine:** 7 — Class 1 — Dairy Breeds, Class 2 — Asian & African Breeds, Class 3 — British Breeds, Class 4 — Continental Breeds, Class 5 — American Breeds, Class 6 — Build a Breed Project, Class 7 — Final Assessment & Build a Breed Project
...
- `lesson:breeds-of-livestock-cattle:l7` — Class 7 — Final Assessment & Build a Breed Project

## Unit `external-anatomy-of-livestock-terms-terminology`

**Title:** External Anatomy of Livestock: Terms & Terminology
**Spine:** 6 — Class 1 — Anatomical Terms of Location, Class 2 — External Components of Livestock, Class 3 — Livestock External Anatomy Diagrams, Class 4 — Labeling (Gilt, Ram, Ewe, Buck) & Livestock Instructor Project, Class 5 — Labeling (Doe, Horse, Chicken) & Livestock Instructor Project, Class 6 — Assessment & Livestock Instructor Project
...
- `lesson:external-anatomy-of-livestock-terms-terminology:l4` — Class 4 — Labeling (Gilt, Ram, Ewe, Buck) & Livestock Instructor Project
- `lesson:external-anatomy-of-livestock-terms-terminology:l5` — Class 5 — Labeling (Doe, Horse, Chicken) & Livestock Instructor Project
- `lesson:external-anatomy-of-livestock-terms-terminology:l6` — Class 6 — Assessment & Livestock Instructor Project


## Path score (gold)

**FAIL** — 20/22 (see `PATH-SCORE.md`)
