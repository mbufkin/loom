...
|-------------|---------------|------|
| `023-breeds-of-livestock-cattle__action-plan.html` | `student_practice` | **E** |
...
**Spine:** 6 — Class 1 — Anatomical Terms of Location, Class 2 — External Components of Livestock, Class 3 — Livestock External Anatomy Diagrams, Class 4 — Labeling Activities & Livestock Instructor Project, Class 5 — Labeling Activities & Livestock Instructor Project, Class 6 — Assessment & Livestock Instructor Project
...
- `lesson:external-anatomy-of-livestock-terms-terminology:l4` — Class 4 — Labeling Activities & Livestock Instructor Project
- `lesson:external-anatomy-of-livestock-terms-terminology:l5` — Class 5 — Labeling Activities & Livestock Instructor Project
- `lesson:external-anatomy-of-livestock-terms-terminology:l6` — Class 6 — Assessment & Livestock Instructor Project


## Path score (gold)

**PASS** — 22/22 (see `PATH-SCORE.md`)
