...
**Spine:** 7 — Class 1 — Dairy Breeds, Class 2 — Asian & African Breeds, Class 3 — British Breeds, Class 4 — Continental Breeds, Class 5 — American Breeds, Class 6 — Build a Breed Project, Class 7 — Cattle Breeds Flashcards / Final Assessment

| source_file | artifact_kind | Path |
|-------------|---------------|------|
| `023-breeds-of-livestock-cattle__action-plan.html` | `lesson_plan` | **A** |
...
| `023-breeds-of-livestock-cattle__key-concepts.html` | `student_practice` | **E** |
...
- `lesson:breeds-of-livestock-cattle:l7` — Class 7 — Cattle Breeds Flashcards / Final Assessment

## Unit `external-anatomy-of-livestock-terms-terminology`

**Title:** External Anatomy of Livestock: Terms & Terminology
**Spine:** 6 — Class 1 — Anatomical Terms of Location, Class 2 — External Components of Livestock, Class 3 — External Anatomy of Cattle, Class 4 — External Anatomy of Swine, Class 5 — External Anatomy of Sheep, Class 6 — External Anatomy of Goats

| source_file | artifact_kind | Path |
|-------------|---------------|------|
| `027-external-anatomy-of-livestock-terms-terminology__action-plan.html` | `student_practice` | **E** |
...
| `027-external-anatomy-of-livestock-terms-terminology__project-livestock-instructor.html` | `student_practice` | **E** |
...
- `lesson:external-anatomy-of-livestock-terms-terminology:l3` — Class 3 — External Anatomy of Cattle
- `lesson:external-anatomy-of-livestock-terms-terminology:l4` — Class 4 — External Anatomy of Swine
- `lesson:external-anatomy-of-livestock-terms-terminology:l5` — Class 5 — External Anatomy of Sheep
- `lesson:external-anatomy-of-livestock-terms-terminology:l6` — Class 6 — External Anatomy of Goats


## Path score (gold)

**FAIL** — 21/22 (see `PATH-SCORE.md`)

- FAIL `023-breeds-of-livestock-cattle__action-plan.html`: expected `student_practice→E`, got `lesson_plan→A`
