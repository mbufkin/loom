...
│  Layer 0 elements → Loom router (Path A–H) →            │
...
| **Models** | Judgment calls on messy filenames, Layer 0/1 semantics, Loom routing (Path A–H decision), model calendars, hybrid first-pass / teacher narrative |
